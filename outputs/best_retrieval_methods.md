...
The best clean final result is the reliability-weighted hybrid text + visual
fusion. It improves `recall@10` by `+0.0652` over the recomputed CLIP text-only
baseline and by `+0.0079` over the original hybrid text + visual fusion.
